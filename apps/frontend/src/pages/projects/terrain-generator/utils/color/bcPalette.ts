...
export const ELEVATION_THRESHOLDS = {
  deepWater: 0.3, // Below this = deep water
  sand: 0.35, // 0.30-0.35 = beach/shore
  grass: 0.5, // 0.35-0.50 = grasslands
  forest: 0.7, // 0.50-0.70 = forest
  rock: 0.85, // 0.70-0.85 = rocky mountain
  snow: 1.0, // 0.85-1.00 = snow peaks
};
 ...
 */
export function rgbToThreeColor(
  r: number,
  g: number,
  b: number,
