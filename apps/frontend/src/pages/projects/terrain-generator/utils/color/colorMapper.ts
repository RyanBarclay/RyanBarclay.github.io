...
function getBCNatureColor(elevation: number): [number, number, number] {
  ...
  if (elevation <= thresholds.sand) {
    const t =
      (elevation - thresholds.deepWater) /
      (thresholds.sand - thresholds.deepWater);
  ...
  if (elevation <= thresholds.grass) {
    const t =
      (elevation - thresholds.sand) / (thresholds.grass - thresholds.sand);
  ...
  if (elevation <= thresholds.forest) {
    const t =
      (elevation - thresholds.grass) / (thresholds.forest - thresholds.grass);
  ...
  if (elevation <= thresholds.rock) {
    const t =
      (elevation - thresholds.forest) / (thresholds.rock - thresholds.forest);
  ...
  if (elevation <= thresholds.snow) {
    const t =
      (elevation - thresholds.rock) / (thresholds.snow - thresholds.rock);
